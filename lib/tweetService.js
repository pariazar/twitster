...
const { extractTweetsInfo, findTokenPage, extractUserList, extractUserDetail, extractTweetDetail } = require('./tweetParser');
...
exports.findTopTweets = async (keyword, options = {}) => {
    ...
    return await extractTweetsInfo(res.data, options.language);
}
